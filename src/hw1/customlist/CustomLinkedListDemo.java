...
public class CustomLinkedListDemo {
	public static void main(String[] args) {
		...
		Node<Integer> num4 = list.getNode(1);
		System.out.println("getNode(1) : " + num4.item); // expected output: "getNode(1) : 50

		int num5 = list.indexOf(200); 
		System.out.println("indexOf(200) : " + num5); // expected output: "indexOf(200) : 2"
